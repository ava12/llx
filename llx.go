/*
Package llx is a general-purpose LL(*) parser.
...
Consists of subpackages:
  ...
  - llxgen: console utility converting grammar description to Go source file containing grammar definition structure;
...
3. Define hooks to handle tokens and/or non-terminals generated by parser.

4. Create new parser for desired grammar and feed source files and hooks.
